...
Del Nobilissimo Gioco}\\ \normalsize \textls[1000]{delle}\\ \fontsize{34}{34}\selectfont{\textls[100]{MINCHIATE}}}
\author{%
  \vspace{-26pt}\\
\textit{Con un modo breve, e facile}\\
\textit{\textls[86]{per ben imparare a giocarlo}}\\}
\date{%
  \kern 3em\small In Roma, Per Raffaelle Peverono. 1728\\ \sepline
...
Leveder girare questo
picciolo Libricciolo sotto di un tiP™ solo così speciofo di
Regole generali del Gioco
delle Minchiate ; fon ficuros
benigno Lettore 5 che ti rechera qualche forte di maraviglia:
prima perche hai vedato altre
volte stampate queste Regole.
waza alcun frutto, ¢ poe per
che bai trovato rn ogni conversazione
ove prattichi,che opin
uno gioca quesie gioco a capriccio, e con regole diverse, e per
esser bravo Giocutore basta afferire con franchezxa la
...
‘A. ‘
ancorche non vera; poco importando,
che questa prattica degea
nevi in abuso; e ficcome queffo
...
fe poi queste ragioni da noz
addotte non foffero tal’, che
poteffero capacitarti 2 baflanza: sappi che io mi contento
...
complacct direndermt una ragiene maggiore, la quale faccia
coftare essere falfa la prima 5
mentre ioche #0n hd mai avuta
altra idea nel fare questa picciola raccolta, che diftruggere
ogni abuso, per publico beneficio,e rendere guefto Gioco fen=
za competenza di prattica egua~
le in tutte le conver [azioni, mé
sapro sottofcrivere dibuonavoglia al two faggio,e miglior pa~
rere ogni qual volta lo conofeev0 fondato si la ragione. Del
refio vivi felice .
  

49, al male per gevio, e
Nosema @ per natura, che ftima
debolezza di fpirito fignorile, evilta d’animo nobile Pintraprendere per suo divertimento
qualche qnorato impiego, 4 fegno tale, che vuole più tosto
...
vato questo abuso, perche veramente ¢ flato conofciuto. jngiu«
...
avverfarijse ficcome succede's
